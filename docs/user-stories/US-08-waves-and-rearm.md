...
- At wave start (including after a completed wave), every battery is restored and refilled to 10 missiles (destroyed bases come back).
...
- All batteries show 10 missiles after rearm and are fireable again (including ones destroyed during the previous wave).
