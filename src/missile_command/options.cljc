...
(defn open
  ...
  [state]
  (screens/open-from-title state screens/options))

(defn leave
  "Return from options to title."
  [state]
  (screens/return-to-title-when state screen?))
