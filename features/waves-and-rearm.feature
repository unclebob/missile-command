...
Scenario: Waves and rearm 02 wave does not complete while enemies remain
  ...
  And the first enemy missile progress is less than <progress_ceiling>
  And the wave is not complete

Examples:
  | width | height | remaining | wave | enemy_count | expected_applied_dt | progress_ceiling | expected_width | expected_height |
  | 800   | 600    | 1         | 1    | 1           | 0.05                | 0.1              | 800            | 600             |
  | 800   | 600    | 3         | 1    | 3           | 0.05                | 0.1              | 800            | 600             |
  | 1920  | 1080   | 2         | 1    | 2           | 0.05                | 0.1              | 1920           | 1080            |
